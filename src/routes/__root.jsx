...
export const Route = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Pathan Zaid Khan" },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Pathan Zaid Khan · Photography" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#141a15" },
    ],
    links: [
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Person",
          name: "Pathan Zaid Khan",
          jobTitle: "Photographer & B.Tech Student",
          description:
            "Self-taught documentary and portrait photographer, currently studying B.Tech in India.",
          email: "pathanzaidkhan.photo@gmail.com",
        }),
      },
    ],
  }),
